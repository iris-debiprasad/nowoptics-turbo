...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Elite Signature Eyewear - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Shop the Elite Signature eyewear collection at Stanton Optical. Discover luxury eyeglasses and sunglasses designed for superior style and comfort."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.NEW_ARRIVAL_GLASSES;
