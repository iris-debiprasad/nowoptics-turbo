...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`All Eye Health Products - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Enhance your vision with our premium eye health products range. Discover better eye care solutions now! See clearer, live better. Shop online or in-store today!"
        />
...
//   const query = facetKeyMappingWithPathName.CATALOG_ALLEYEHEALTH_PRODUCTS;
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.CATALOG_ALLEYEHEALTH_PRODUCTS;
