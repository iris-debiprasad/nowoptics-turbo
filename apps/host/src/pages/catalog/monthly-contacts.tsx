...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>
          {`${t("CONTACT/MONTHLY.META.TITLE")} - ${BRAND_NAME[brand]}`}
        </title>
        <meta
          name="description"
          content="Discover bestselling monthly contact lenses at Stanton Optical. Look at our extensive contacts catalog of the leading brands at attractive prices. Buy now."
        />
...
//   const query = facetKeyMappingWithPathName.CATALOG_MONTHLY_CONTACTS;
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.CATALOG_MONTHLY_CONTACTS;
