...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>
          {`${t("CONTACT/BI-WEEKLY.META.TITLE")} - ${BRAND_NAME[brand]}`}
        </title>
        <meta
          name="description"
          content={`Buy bestselling bi-weekly disposable contact lenses at ${BRAND_NAME[brand]}. Look at our extensive catalog of the top leading brands at attractive prices. Shop now!`}
        />
...
//   const query = facetKeyMappingWithPathName.CATALOG_BIWEEKLY_CONTACTS;
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.CATALOG_BIWEEKLY_CONTACTS;
