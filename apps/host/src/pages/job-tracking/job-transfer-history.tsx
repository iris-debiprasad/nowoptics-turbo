...
const JobTransferHistoryComponent = dynamic(() => import("order/JobTransferHistory"), {
  ssr: false,
  loading: () => (
...
function JobTransferHistory() {
  ...
  return (
    <>
      <Head>
        <title>Job Transfer History | Stanton Optical</title>
        <meta
          name="description"
      ...
      <JobTransferHistoryComponent />
    </>
  );
}

export default JobTransferHistory;
