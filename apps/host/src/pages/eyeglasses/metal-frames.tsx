...
const Products = (props: { facets: any }) => {  
  ...
  return (
    <>
      <Head>
        <title>{`Metal Frame Glasses Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Metal frame glasses deliver a classic style, combining durability and lasting quality beyond what plastic frames can offer. Discover the perfect pair for you now."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.EYEGLASSES_METAL_FRAMES;
