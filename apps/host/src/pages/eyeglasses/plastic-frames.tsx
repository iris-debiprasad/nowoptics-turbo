...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Plastic Glasses Frames Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Plastic glasses frames offer a stylish, lightweight look that blends comfort with versatility. Explore our collection to find the perfect pair for you."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.EYEGLASSES_PLASTIC_FRAMES;
