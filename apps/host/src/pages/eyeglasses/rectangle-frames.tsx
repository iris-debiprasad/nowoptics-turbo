...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Rectangle Frame Glasses Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Rectangle frame glasses offer a sharp, modern look that adds structure and sophistication. Explore our collection to find the perfect rectangular pair for you today"
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.EYEGLASSES_RECTANGLE_FRAMES;
