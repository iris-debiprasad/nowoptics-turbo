...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Square Frame Glasses Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Square frame glasses offer a bold, modern look that adds definition and structure to your style. Browse our collection and find your perfect square frames today."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.EYEGLASSES_SQUARE_FRAMES;
