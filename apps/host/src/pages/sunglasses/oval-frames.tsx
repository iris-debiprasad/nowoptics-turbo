...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Oval Sunglasses Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Oval sunglasses offer a timeless, effortlessly chic style that complements any look. Explore our collection to find your perfect oval pair today."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.SUNGLASSES_OVAL_FRAMES;
