...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Rectangle Sunglasses Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Rectangle sunglasses offer a sleek, contemporary look, combining sharp lines with versatile style. Explore our collection and find your perfect rectangular pair today."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.SUNGLASSES_RECTANGLE_FRAMES;
