...
export const BLOGS: IBlogMeta[] = [
  {
    image: BLOG_IMAGES.RESTORE_SIGHT_CHANGE_LIVES,
    date: "April 24th, 2025",
    description:
      "Transform lives by donating your old glasses through Stanton Optical's partnership with Charity Vision. Give the gift of sight to those in need.",
    tag: "Eye Care",
    title:
      "Donate Glasses, Restore Sight with Stanton Optical",
    url: "/blog/restore-sight-change-lives",
  },
  {
    image: BLOG_IMAGES.EASY_REMOVAL_CONTACT_BLOG_TILE_MOBILE,
    date: "April 17th, 2025",
    description:
      "Learn the step-by-step guide to removing contact lenses safely. Tips, hygiene, and expert advice for healthy, irritation-free eyes.",
    tag: "Contact Lenses",
    title:
      "How to Remove Contact Lenses Safely",
    url: "/blog/easy-removal-guide-contact-lenses",
  },
  {
    image: BLOG_IMAGES.WOMEN_EYE_HEALTH_BLOG_TILE_MOBILE,
    date: "April 10th, 2025",
    description:
      "Learn why women are at higher risk for eye conditions like dry eye & cataracts. Discover simple steps to nurture your vision starting today",
    tag: "Eye Health",
    title:
      "Why Women’s Eye Health Matters",
    url: "/blog/why-womens-eye-health-matters",
  },
  {
...
export const BLOGS_PAGES: Record<string, IBlog_Page> = {
  ...
  "why-womens-eye-health-matters": {
    alt: "Why Women’s Eye Health Matters",
    title:
      "Why Women’s Eye Health Matters",
    date: "April 10th, 2025",
    tag: "Eye Health",
    url: "/why-womens-eye-health-matters/",
    content: {
      content1: `<style type="text/css"> ul { list-style-type: none; padding-inline-start: 0 !important; } h1 { font: 400 1.5rem Recoleta !important } h2 { font: 400 1.4rem Roboto !important } .link { color: #004098; font-weight: 700 } .link:focus-visible, .link:hover { text-decoration: underline } .img { height: auto; object-fit: cover; width: 100% } .desktop { display: block; } .mobile { display: none; } .content { display: flex; align-items: center; column-gap: 3rem; } .content__right { display: flex; justify-content: center; } .content-top { flex-direction: row; } .content-bottom { flex-direction: row-reverse; } .content-bottom .content__right { width: 100%; } .content-top .content__right { width: 150%; } @media screen and (min-width:600px) { h1, h2 { font-size: 2rem !important } } @media screen and (max-width:768px) { .content-top { flex-direction: column; } .content-bottom { flex-direction: column; } .content-top .content__right { width: 100%; margin-bottom: 20px; } .content-bottom .content__right { width: 100%; } .desktop { display: none; } .mobile { display: block; } } </style> <h1>Why Women’s Eye Health Matters</h1> <img class="img desktop" alt="Why Women’s Eye Health Matters" src=${BLOG_IMAGES.WOMEN_EYE_HEALTH_BLOG_TILE_DESKTOP} style="margin-top:1rem"><img class="img mobile" alt="Why Women’s Eye Health Matters" src=${BLOG_IMAGES.WOMEN_EYE_HEALTH_BLOG_TILE_MOBILE} style="margin-top:1rem"> <p>Did you know that women are at a higher risk for a range of eye conditions? If you didn’t, don’t worry—you’re not alone. It’s one of those health topics that doesn’t get enough attention. But your eyes go through a lot, and being aware of their unique needs is one of the best gifts you can give yourself.<br />From hormonal changes to pregnancy and aging, women’s eye health faces unique challenges. Today, we’re breaking it all down for you, so grab your favorite cuppa and settle in.</p> <section class="content content-top"> <div class="content__left"> <h2>Common Eye Conditions Women Face</h2><br /> <p>Studies show that women are more prone to certain eye issues due to the effects of hormones on the body (<a class="link" href="https://www.aao.org/newsroom/news-releases/detail/women-face-higher-risk-of-blindness-than-men" target="_blank">American Academy of Ophthalmology</a>). Here’s a quick rundown of the most common culprits:</p><br /> <ul> <li><strong>Dry Eye Syndrome</strong>: If your eyes burn, itch, or feel constantly irritated, this is likely the cause. Dry eyes are more common in women, especially post-menopause, as hormonal dips affect tear production.</li> <li><strong>Cataracts</strong>: More than half of people over 80 experience these cloudy patches that form on the lens of the eye. Unfortunately, women are more likely to develop cataracts than men.</li> <li><strong>Cholesterol Issues</strong>: Yellowish deposits around the eyes or changes in your retina can signal high cholesterol levels.</li> <li><strong>Age-Related Macular Degeneration (AMD)</strong>: Ladies, as much as we don’t love focusing on aging, it’s important to discuss how AMD can blur the center of your vision. Risk factors include age, smoking, and—you guessed it—being female (<a class="link" href="https://www.nei.nih.gov/learn-about-eye-health/outreach-resources/outreach-materials/women-and-eye-health" target="_blank">National Eye Institute</a>).</li> </ul> <p>Understanding these conditions is the first step in protecting your vision (and keeping those peepers healthy for beautiful sunsets and guilty-pleasure binge-watching marathons).</p><br /><br /> </div> <figure class="content__right"> <img class="img" alt="Common Eye Conditions Women Face" src=${BLOG_IMAGES.WOMEN_EYE_HEALTH_BLOG_TILE_IMAGE1}> </figure> </section> <br /> <h2>How Hormones Affect Your Vision</h2> <p>How exactly can hormones affect your eyesight? Hormonal changes during key life stages—like pregnancy, menopause, and even menstruation—can significantly impact your eyesight. During pregnancy, for example, swelling and fluid retention can change your prescription temporarily. And during menopause, those hormonal shifts can pave the way for dry eyes and pesky blurriness.</p> <p>Listen, the good news is that these changes are often manageable. Annual eye checkups can help catch any issues early, so you can address them before they disrupt your daily life.</p><br /> <section class="content content-bottom"> <div class="content__left"> <h2>Action Steps to Prioritize Your Eye Health</h2><br /> <p>Treat your eyes with the same care you give to your skin or your fitness routine. Here’s how to start right now:</p><br /> <ul> <li><strong>Schedule Regular Eye Exams</strong>: This is a non-negotiable. Your eye doctor is your new BFF when it comes to catching early signs of trouble.</li> <li><strong>Use Proper Sun Protection</strong>: Sunglasses aren’t just for Insta selfies—they help block harmful UV rays that can lead to cataracts. And FYI, at Stanton Optical you can turn any frame into sunglasses…just saying.</li> <li><strong>Eat for Eye Health</strong>: Stock up on foods rich in omega-3 fatty acids (think salmon and walnuts), leafy greens (hello, kale salad), and antioxidant-packed berries.</li> <li><strong>Stay Hydrated</strong>: Simple but powerful—water helps maintain healthy moisture levels in your eyes.</li> </ul> </div> <figure class="content__right"> <img class="img" alt="Action Steps to Prioritize Your Eye Health" src=${BLOG_IMAGES.WOMEN_EYE_HEALTH_BLOG_TILE_IMAGE2}> </figure> </section> <h2>See Clearly and Confidently</h2> <p>Your eyes deserve love, care, and attention. From dry eyes to changes caused by aging and hormones, being proactive about your vision can make a world of difference.</p> <p><strong>Book your next eye exam today and treat your eyes to the care they deserve.</strong></p> <span>References:</span> <div> <a style="font-style: italic;" class="link" href="https://www.aao.org/newsroom/news-releases/detail/women-face-higher-risk-of-blindness-than-men" target="_blank">American Academy of Ophthalmology – Women’s Risk of Blindness</a> <br /> <a style="font-style: italic;" class="link" href="https://www.nei.nih.gov/learn-about-eye-health/outreach-resources/outreach-materials/women-and-eye-health" target="_blank">National Eye Institute – Women and Eye Health</a></div>`,
    },
    meta: {
      title:
        "Why Women’s Eye Health Matters",
  ...
  "easy-removal-guide-contact-lenses": {
    alt: "How to Remove Contact Lenses Safely",
    title:
      "How to Remove Contact Lenses Safely",
    date: "April 17th, 2025",
    tag: "Contact Lenses",
    url: "/easy-removal-guide-contact-lenses/",
    content: {
      content1: `<style type="text/css"> ol { padding-inline-start: 1rem !important; } h1 { font: 400 1.5rem Recoleta !important } h2 { font: 400 1.4rem Roboto !important } .link { color: #004098; font-weight: 700 } .link:focus-visible, .link:hover { text-decoration: underline } .img { height: auto; object-fit: cover; width: 100% } .desktop { display: block; } .mobile { display: none; } .content { display: flex; align-items: center; column-gap: 3rem; } .content__right { display: flex; justify-content: center; } .content-top { flex-direction: row; } .content-bottom { flex-direction: row; } .content-bottom .content__right { width: 150%; } .content-top .content__right { width: 150%; } @media screen and (min-width:600px) { h1, h2 { font-size: 2rem !important } } @media screen and (max-width:768px) { .content-top { flex-direction: column-reverse; } .content-bottom { flex-direction: column; } .content-top .content__right { width: 100%; margin-bottom: 20px; } .content-bottom .content__right { width: 100%; } .desktop { display: none; } .mobile { display: block; } } </style> <h1>Easy Removal Guide: Contact Lenses</h1> <img class="img desktop" alt="Easy Removal Guide: Contact Lenses" src=${BLOG_IMAGES.EASY_REMOVAL_CONTACT_BLOG_TILE_DESKTOP} style="margin-top:1rem"><img class="img mobile" alt="Easy Removal Guide: Contact Lenses" src=${BLOG_IMAGES.EASY_REMOVAL_CONTACT_BLOG_TILE_MOBILE} style="margin-top:1rem"> <p>If you’re new to wearing contact lenses, removing them might seem like a daunting task. Maybe you’re worried about touching your eyes or getting the lens stuck. But don’t worry—you’re not alone! With a little practice and the right steps, removing your contacts will soon feel like second nature. Think of it as one of those small routines, like tying your shoes, that become effortless over time.</p> <p>This guide will walk you through how to remove your contact lenses safely while maintaining optimal eye health. Along the way, you’ll get tips and reminders to keep your eyes comfortable and healthy.</p> <h2>Step-by-Step Guide to Removing Contact Lenses Safely</h2> <p>Removing your contact lenses is simple when you break it down into clear steps. Here’s how to do it:</p> <section class="content content-bottom"> <div class="content__left"> <ol> <li><strong>Wash Your Hands Thoroughly</strong>:<br /> Before touching your eyes, wash your hands with soap and water. Make sure to use a clean, lint-free towel to dry them. Clean hands are essential to prevent bacteria or irritants from getting into your eyes. (Pro tip: Avoid scented soaps that could leave residues behind.)</li> <li><strong>Ensure Proper Lighting and a Mirror</strong>:<br /> Find a well-lit, comfortable space with a mirror. This will help you see your lenses clearly and make the process easier.</li> <li><strong>Blink a Few Times to Relax Your Eyes</strong>:<br /> If your eyes feel dry, use a few drops of rewetting solution to moisten them. Blink a couple of times to calm your nerves before getting started. </li> <li><strong>Look Up and Pull Down Your Lower Eyelid</strong>:<br /> Using your non-dominant hand, gently pull your lower eyelid down. With your dominant hand, use your index finger to touch the lens gently—just enough to move it away from your eye’s center.</li> <li><strong>Pinch the Lens Gently</strong>:<br /> With your thumb and index finger, softly pinch the lens and lift it away from your eye. Be gentle to avoid tearing the lens or irritating your eye.</li> <li><strong>Clean or Dispose of the Lens</strong>:<br /> If you wear disposable lenses, throw them away after removing them. For reusable lenses, clean them immediately using the recommended solution and store them in a clean lens case.</li> <li><strong>Repeat for the Other Eye</strong>:<br /> Follow the same process for your other eye, and you’re done! </li> </ol> </div><br /><br /> <figure class="content__right"> <img class="img" alt="Common Eye Conditions Women Face" src=${BLOG_IMAGES.EASY_REMOVAL_CONTACT_BLOG_TILE_IMAGE1}> </figure> </section> <br /> <h2>Why Clean Hands Matter</h2> <p>It all starts with hygiene! Dirty hands are a top cause of eye infections like conjunctivitis (commonly known as pink eye). According to the <a class="link" href="https://www.aao.org/eye-health/glasses-contacts/contact-lens-102" target="_blank">American Academy of Ophthalmology</a>, not washing your hands before touching your lenses significantly increases your risk of introducing harmful bacteria or debris into your eyes. Taking just 20 seconds to wash your hands can save you from days (or weeks) of eye irritation.</p> <h2>What You Shouldn’t Do:</h2><br /> <ul> <li>Don’t use your nails to remove the lens—this can scratch your eye.</li> <li>Avoid rinsing your hands or lenses with tap water, as it may contain impurities that can harm your eyes. </li> <li>Never skip cleaning your reusable lenses—it’s a crucial step in keeping your eyes healthy.</li> </ul> <h2>Benefits of Proper Contact Lens Removal</h2> <p>Removing your lenses properly isn’t just about getting them out easily—it’s about protecting your sight and ensuring comfort. Here are the benefits of following these steps:</p> <p> <strong>Reduced Risk of Irritation or Infection</strong>: Gentle handling and clean hands minimize exposure to bacteria.<br /> <strong>Extended Lens Life</strong>: For reusable lenses, proper cleaning enhances their lifespan.<br /> <strong>Comfortable Eyes</strong>: Removing your lenses correctly ensures your eyes stay hydrated and strain-free.<br /></p> <p>Follow an eye-care ritual that supports good habits today for healthier eyes tomorrow.</p> <h2>Your Eyes Deserve Care Every Day</h2> <p>Remember, your eyes are delicate, and your contact lenses are there to enhance your vision—not harm them. By practicing proper lens removal, you’ll keep your eyes healthy and your lenses in great condition. Plus, as you get more comfortable, the process will become quicker and easier.<br />If you’re still finding it tricky to remove your lenses or have questions about your routine, don’t hesitate to discuss it with your local Stanton Optical Eye Care Specialist. Schedule an eye appointment if you notice redness, prolonged dryness, or discomfort.</p> <p>Taking control of your care is a small step toward ensuring your vision remains crystal clear for years to come. You’ve got this!</p><span>References:</span> <div> <a style="font-style: italic;" class="link" href="https://www.aao.org/eye-health/glasses-contacts/contact-lens-care" target="_blank">American Academy of Ophthalmology - Contact Lens Safety</a> <br /> <a style="font-style: italic;" class="link" href="https://www.mayoclinic.org/departments-centers/contact-lenses/overview/ovc-20518723" target="_blank">Mayo Clinic - Contact Lenses Do's and Don'ts</a></div>`,
    },
    meta: {
      title:
        "How to Remove Contact Lenses Safely",
  ...
  "restore-sight-change-lives": {
    alt: "Donate Glasses, Restore Sight with Stanton Optical",
    title:
      "Donate Glasses, Restore Sight with Stanton Optical",
    date: "April 24th, 2025",
    tag: "Eye Care",
    url: "/restore-sight-change-lives/",
    content: {
      content1: `<style>ol{padding-inline-start:1rem!important}h1{font:400 1.5rem Recoleta!important}h2{font:500 1.4rem Roboto!important}.link{color:#004098;font-weight:700}.link:focus-visible,.link:hover{text-decoration:underline}.img{height:auto;object-fit:cover;width:100%}.desktop{display:block}.mobile{display:none}.content{display:grid;align-items:center;column-gap:3rem;grid-template-columns:.5fr .4fr}.content h2{margin-bottom:20px}.content p{margin-bottom:20px}.content__right{display:flex;justify-content:center}.content-top{flex-direction:row}.content-bottom{flex-direction:row-reverse}.content-bottom .content__right{width:100%;display:block}.content-top .content__right{width:130%}@media screen and (min-width:600px){h1,h2{font-size:2rem!important}}@media screen and (max-width:768px){p{font-size:15px}.content{display:flex}.content-top{flex-direction:column-reverse}.content-bottom{flex-direction:column}.content-top .content__right{width:100%;margin-bottom:20px}.content-bottom .content__right{width:100%}.desktop{display:none}.mobile{display:block}}</style><h1>Restore Sight, Change Lives</h1><img alt="Donate Glasses, Restore Sight with Stanton Optical"class="img desktop"src=${BLOG_IMAGES.RESTORE_SIGHT_CHANGE_LIVES_DESKTOP} style=margin-top:1rem><img alt="Donate Glasses, Restore Sight with Stanton Optical"class="img mobile"src=${BLOG_IMAGES.RESTORE_SIGHT_CHANGE_LIVES} style=margin-top:1rem><h2>How Stanton Optical and CharityVision are Making a Difference</h2><p>For 1 in 8 people worldwide, clear vision is out of reach. <b>Stanton Optical</b>, in partnership with <b>CharityVision</b>, is on a mission to change that. Together, we’re restoring sight and creating opportunities for those in need.<p>For over five years, <b>Stanton Optical</b> has been CharityVision’s most consistent donor, supporting their mission to “Restore Lives Through Sight.” Through this partnership, our stores send donated eyeglass frames directly to <b>CharityVision’s</b> distribution center in Utah. Volunteers carefully sort the frames, preparing them for their next chapter in schools, homeless shelters, and underserved communities around the world.<p>Our efforts led to a milestone in 2023, when <b>Stanton Optical</b> donated over 100,000 frames, changing the lives of children and adults globally. This achievement is a testament to the power of giving.<h2></h2><section class="content content-top"style=margin-bottom:50px><div class=content__left><h2>Why Your Frames Matter</h2><p>Donating your old glasses can transform someone's life.<p style=margin-bottom:10%><strong>Education:</strong> A child can finally see the blackboard and reach their potential.<br><strong>Employment:</strong> Clear vision opens doors to stable work and financial security.<br><strong>Confidence:</strong> Restored sight fosters self-esteem and independence.<br><strong>Health:</strong> Vision correction prevents issues like headaches and eye strain.<h2>The Journey of Your Glasses</h2><p>When you donate, your frames travel to CharityVision’s center, where volunteers sort and prepare them for recipients worldwide. Many go to schools or shelters, delivering the gift of sight and a brighter future.</div><figure class=content__right><img alt="Donate Glasses, Restore Sight with Stanton Optical"class=img src=${BLOG_IMAGES.RESTORE_SIGHT_CHANGE_LIVES_GIRL}></figure></section><section class="content content-bottom"><figure class=content__left><img alt="Donate Glasses, Restore Sight with Stanton Optical"class=img src=${BLOG_IMAGES.RESTORE_SIGHT_CHANGE_LIVES_KIDS}></figure><div class=content__right><h2>A Legacy of Vision</h2><p>CharityVision’s story began in 1963 with Dr. Bill Jackson and his wife Audrey’s decision to serve in war-torn Algeria. Over the decades, their work evolved into a global mission led by their son, Doug Jackson, refocusing on eye care. To date, CharityVision has provided over 1.5 million eye surgeries.<h2>How You Can Help</h2><p>Donating is easy.<ol style=margin-bottom:10%><li>Gather your unused glasses.<li>Bring them to your nearest Stanton Optical.<li>Leave knowing you’ve made a difference.</ol></div></section><h2>Be Part of the Vision</h2><p>At Stanton Optical, we believe clear vision is life-changing. By donating your old frames, you join us in bringing sight, hope, and opportunity to those in need. Together, we can transform lives, one pair of glasses at a time.<p>Thank you for being part of this incredible mission.</p><span style=font-style:italic>References:</span><div><div style=font-style:italic>American Academy of Ophthalmology – <a class=link href=https://www.aao.org/education/vision-2020 style=font-style:italic target=_blank>VISION 2020</a></div><br><div style=font-style:italic>National Eye Institute – <a class=link href=https://www.nei.nih.gov/learn-about-eye-health/eye-conditions-and-diseases/nearsightedness-myopia style=font-style:italic target=_blank>Nearsightedness (Myopia)</a></div></div>`,
    },
    meta: {
      title:
        "Donate Glasses, Restore Sight with Stanton Optical",
