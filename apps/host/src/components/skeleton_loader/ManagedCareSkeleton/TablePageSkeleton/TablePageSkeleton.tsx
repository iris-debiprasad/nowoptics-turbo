...
import style from "./TablePageSkeleton.module.scss";

const TablePageSkeleton = () => {
  return (
    <Box className={style.insuranceCarrierWrapper}>
      <Box className={style.insuranceCarrierContainer}>
        <Skeleton
          variant="rectangular"
          height="50px"
          width="300px"
        ...
        <Box className={style.tableContainer}>
          <Box className={style.InsuranceCarriersHeader}>
