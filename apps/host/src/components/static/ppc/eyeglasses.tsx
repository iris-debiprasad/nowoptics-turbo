...
import PPCEyeglassesCarousel from "./ppc-eyeglasses-carousel";
...
const EyeglassesPPC = (props: any) => {
    ...
    const topHeaderImage = ppcPageData.Description.TopSlider1Desktop ? ppcPageData.Description.TopSlider1Desktop : ImageUrlConstants.PPC_EYEGLASSES_TOP_HEADER;
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            const ppcPageDiv = document.getElementById("ppc_page") || document.getElementById("social_page");
    ...
    return (
        <>
            ...
            {props.brand === BRAND.MEL ? <MELPPCTopHeader data={{ ppcPageData, handleBookEyeExamClick, handleOpen, topHeaderImage }} /> : <PPCTopHeader data={{ ppcPageData, handleBookEyeExamClick, handleOpen, topHeaderImage }} />}
            ...
            <PPCSecondaryBanner data={{ ppcPageData, handleBookEyeExamClick, brand: props.brand }} />
            <PPCReview />
            <PPCPromotionalBanner data={{ ppcPageData, handleOpen, handleBookEyeExamClick, brand: props.brand }} />
            <PPCEyeglassesCarousel data={{ brand: props.brand }} />
