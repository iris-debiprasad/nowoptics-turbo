...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Vision Supplements - Eye Health Products - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Enhance your vision with our premium vision supplement products. Discover the best vision supplements now! See clearer, live better. Shop online or in-store today!"
        />
...
//   const query = facetKeyMappingWithPathName.CATALOG_VISION_SUPPLEMENTS;
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.CATALOG_VISION_SUPPLEMENTS;
