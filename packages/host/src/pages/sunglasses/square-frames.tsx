...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Square Sunglasses Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Square sunglasses provide a bold, modern look, combining sharp angles with standout style. Explore our collection and discover your perfect square frames today."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.SUNGLASSES_SQUARE_FRAMES;
