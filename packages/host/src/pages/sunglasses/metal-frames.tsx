...
const Products = (props: { facets: any }) => {  
  ...
  return (
    <>
      <Head>
        <title>{`Metal Frame Sunglasses Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Metal frame sunglasses deliver a timeless, sleek look with lasting durability and style. Explore our collection and find your ideal pair today."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.SUNGLASSES_METAL_FRAMES;
