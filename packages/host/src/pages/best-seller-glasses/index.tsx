...
const Products = (props: { facets: any }) => {
    ...
    return (
        <>
            <Head>
                <title>{`Best Seller Eyeglasses Frames Online & In-store - ${BRAND_NAME[brand]}`}</title>
                <meta
                    name="description"
                    content="Explore our best-selling eyeglass frames, featuring stylish designs loved by many. Find your perfect pair from our most popular selections today."
                />
...
export async function getServerSideProps(context: any) {
    ...
    let query = facetKeyMappingWithPathName.BEST_SELLER_GLASSES;
