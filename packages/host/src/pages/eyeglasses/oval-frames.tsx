...
const Products = (props: { facets: any }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Oval Glasses Frames Online & In-store - ${BRAND_NAME[brand]}`}</title>
        <meta
          name="description"
          content="Oval glasses frames offer a timeless, versatile look, complementing a variety of face shapes. Browse our collection to find your perfect oval pair today."
        />
...
export async function getServerSideProps(context: any) {
  ...
  let query = facetKeyMappingWithPathName.EYEGLASSES_OVAL_FRAMES;
